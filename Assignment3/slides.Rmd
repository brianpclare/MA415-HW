...
1. Based on csv files, we compare the apprehensions by sectors and months between 2010 and 2017. First of all, we sum up apprehensions by sectors and create the following plot.
```{r}
plot_by_sectors(13)
```

2. Second of all, we sum up apprehensions by months and create the following plot.
```{r}
plot_by_months(10)
```

Based on these two graphs, it is easy to conclude that in 2010, Tucson has the most apprehensions. In 2017, Rio Grande Valley has the most apprehensions. In 2010, from March to May, there are most apprehensions. In 2017, from October to December, there are most apprehensions. To illustrate the problem and see the problem in a more dynamic way, we also build a shiny app and the website is: https://eileenli.shinyapps.io/Assignment3/.
